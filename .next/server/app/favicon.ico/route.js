...
;(() => {
            ...
            3777: (A, e, t) => {
                ...
                let P = 'force-static',
                    D = new r.AppRouteRouteModule({
                        ...
                        resolvedPagePath:
                            'next-metadata-route-loader?page=%2Ffavicon.ico%2Froute&isDynamic=0!/Users/jay.imbery/Documents/git/personal/dubvsub/app/favicon.ico?__next_metadata_route__',
                        nextConfigOutput: '',
                        userland: i,
                    }),
                    {
                    ...
                    D = class {
                        constructor(A) {
                            ...
                            if (e) {
                                let A = w(e)
                                for (let [e, t] of A)
                                    this._parsed.set(e, { name: e, value: t })
                            }
                        }
                        [Symbol.iterator]() {
                        ...
                        toString() {
                            return [...this._parsed.values()]
                                .map(
                                    (A) =>
                                        `${A.name}=${encodeURIComponent(A.value)}`,
                                )
                                .join('; ')
                        }
                    },
                    l = class {
                        ...
                        set(...A) {
                            ...
                            return (
                                ...
                                (function (A, e) {
                                    for (let [, t] of (e.delete('set-cookie'),
                                    A)) {
                                        let A = n(t)
  ...
  `)
            ...
            8098: (A, e, t) => {
                ...
                function a(A, e) {
                    return new URL(
                        String(A).replace(w, 'localhost'),
                        e && String(e).replace(w, 'localhost'),
                    )
                }
            ...
            3169: (A, e, t) => {
                ...
                class a extends Request {
                    constructor(A, e = {}) {
                        let t =
                            'string' != typeof A && 'url' in A
                                ? A.url
                                : String(A)
                        ;(0, r.validateURL)(t),
                            A instanceof Request ? super(A, e) : super(t, e)
                        let o = new i.NextURL(t, {
                            headers: (0, r.toNodeOutgoingHttpHeaders)(
                                this.headers,
                            ),
            ...
            7715: (A, e, t) => {
                ...
                function a(A, e) {
                    ...
                    if (
                        ...
                        let t = []
                        for (let [i, r] of A.request.headers)
                            e.set('x-middleware-request-' + i, r), t.push(i)
                ...
                class s extends Response {
                    ...
                    static redirect(A, e) {
                        ...
                        return (
                            o.set('Location', (0, r.validateURL)(A)),
                            new s(null, { ...i, headers: o, status: t })
                        )
                    }
                    static rewrite(A, e) {
            ...
            446: (A, e, t) => {
                ...
                function o(A, e, t, o) {
                    ...
                    let n = A.toLowerCase()
                    return !o &&
                        ((0, r.pathHasPrefix)(n, '/api') ||
                            (0, r.pathHasPrefix)(n, '/' + e.toLowerCase()))
                        ? A
            ...
            2020: (A, e, t) => {
                ...
                function n(A, e) {
                    ...
                    w &&
                        ...
                        ((P.pathname = (0, r.removePathPrefix)(P.pathname, w)),
                        (P.basePath = w))
                    let D = P.pathname
                    if (
                        P.pathname.startsWith('/_next/data/') &&
                        P.pathname.endsWith('.json')
                    ) {
                        let A = P.pathname
                                .replace(/^\/_next\/data\//, '')
                                .replace(/\.json$/, '')
                    ...
                    if (a) {
                        ...
                        ;(P.locale = A.detectedLocale),
                            (P.pathname =
                                null != (n = A.pathname) ? n : P.pathname),
                            !A.detectedLocale &&
                                P.buildId &&
                                (A = e.i18nProvider
                                    ? e.i18nProvider.analyze(D)
                                    : (0, i.normalizeLocalePath)(D, a.locales))
                                    .detectedLocale &&
                                (P.locale = A.detectedLocale)
                    }
                    return P
