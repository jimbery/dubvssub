            ...
            ;(() => {
                var t = {
                        ...
                        660: (e, t, r) => {
                            ...
                            ;(t.NoopMeterProvider = a),
                                (t.NOOP_METER_PROVIDER = new a())
                        },
                        200: function (e, t, r) {
                            var n =
                        ...
                        846: (e, t, r) => {
                            ...
                            class i {
                                getTracer(e, t, r) {
                                    var a
                                    return null !==
                                        (a = this.getDelegateTracer(e, t, r)) &&
                                        void 0 !== a
                                        ? a
                        ...
                        607: (e, t, r) => {
                            ...
                            ;(t.getSpan = s),
                                (t.getActiveSpan = function () {
                                    return s(
                                        o.ContextAPI.getInstance().active(),
                                    )
                                }),
                                (t.setSpan = l),
                ...
                if ((Array.isArray(e.tags) || (e.tags = []), a)) {
                    ...
                    for (let a of r)
                        (a = `${o.NEXT_CACHE_IMPLICIT_TAG_ID}${a}`),
                            (null == (t = e.tags) ? void 0 : t.includes(a)) ||
                                e.tags.push(a),
                            n.push(a)
                }
                if (i) {
                    ...
                    ;(null == (r = e.tags) ? void 0 : r.includes(a)) ||
                        e.tags.push(a),
                        n.push(a)
                }
                return n
                        ...
                        b =
                            (null == c
                                ...
                                : null == (p = c.method)
                                  ...
                                  : p.toUpperCase()) || 'GET',
                        h =
                            (null == (f = null == c ? void 0 : c.next)
                                ? void 0
                                : f.internal) === !0
                    return await (0, a.getTracer)().trace(
                        h
                            ? n.NextNodeServerSpan.internalFetch
                            : n.AppRenderSpan.fetch,
                        {
                            ...
                            attributes: {
                                ...
                                'http.method': b,
                                'net.peer.name':
                                    null == _ ? void 0 : _.hostname,
                                'net.peer.port':
                                    (null == _ ? void 0 : _.port) || void 0,
                            },
                        },
                        async () => {
                            var n
                            ...
                            let _ =
                                    ...
                                    (null == fetch.__nextGetStaticStore
                                        ? void 0
                                        : fetch.__nextGetStaticStore.call(
                                              fetch,
                                          )),
                                b =
                                    e &&
                            ...
                            'string' == typeof I &&
                                ...
                                'force-cache' === I
                                    ...
                                    : ('no-cache' === I ||
                                          ...
                                          C) &&
                                      (P = 0),
                                ('no-cache' === I || 'no-store' === I) &&
                                    (M = `cache: ${I}`),
                                ('number' == typeof P || !1 === P) && (f = P)
                            let D = O('headers'),
                                L =
                                    'function' ==
                                    typeof (null == D ? void 0 : D.get)
                                        ? D
                                        : new Headers(D || {}),
                            ...
                            if (_.incrementalCache && B)
                                try {
                                    a = await _.incrementalCache.fetchCacheKey(
                                        v,
                                        b ? e : c,
                                    )
                                } catch (t) {
                                ...
                                if (
                                    ...
                                    e.isStale &&
                                        (_.pendingRevalidates ||
                                            (_.pendingRevalidates = []),
                                        _.pendingRevalidates.push(
                                            H(!0).catch(console.error),
                                        ))
                                    let t = e.value.data
                                    g(_, {
                                        start: S,
                                        ...
                                        status: t.status || 200,
                                        method:
                                            (null == c ? void 0 : c.method) ||
                                            'GET',
                                    })
                                    let r = new Response(
                                        Buffer.from(t.body, 'base64'),
                                        {
                                            headers: t.headers,
                                            status: t.status,
                                        },
                ...
                trace(...e) {
                    ...
                    let _ = u.spanName ?? r,
                        S = this.getSpanContext(
                            (null == u ? void 0 : u.parentSpan) ??
                                this.getActiveScopeSpan(),
                        ),
                        b = !1
                    S
                        ? (null == (t = s.getSpanContext(S))
                              ? void 0
                              : t.isRemote) && (b = !0)
                        : ((S = c), (b = !0))
                    let h = v()
